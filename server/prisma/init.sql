...
-- 1. 管理员角色
INSERT IGNORE INTO admin_roles (name, permissions, description, created_at) VALUES
('超级管理员', '["*"]', '拥有所有权限', NOW()),
...
INSERT IGNORE INTO admin_users (username, password, name, role_id, status, created_at, updated_at) VALUES
('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '系统管理员', 1, 'ACTIVE', NOW(), NOW());

-- 3. 商品分类
INSERT IGNORE INTO product_categories (name, icon, parent_id, sort, status, created_at) VALUES
...
-- 4. 农产品分类
INSERT IGNORE INTO farm_categories (name, icon, sort, status, created_at) VALUES
...
-- 5. 话题
INSERT IGNORE INTO topics (name, description, is_top, is_recommend, status, created_at) VALUES
...
-- 6. 系统配置
INSERT IGNORE INTO system_configs (`key`, value, remark, updated_at) VALUES
...
-- 7. 轮播图
INSERT IGNORE INTO banners (title, image_url, link_url, module, sort, status, created_at) VALUES
...
-- 8. 敏感词（示例）
INSERT IGNORE INTO sensitive_words (word, level, status, created_at) VALUES
('赌博', 3, true, NOW()),
('色情', 3, true, NOW()),
('毒品', 3, true, NOW()),
('暴力', 2, true, NOW()),
